<template>
  <div class="main">
    ...
    <el-dialog
      ...
      @close="dialogClose"
    >
      <el-form :model="compileMainBannerData" :rules="rules" ref="ruleForm" label-width="120px"
        ...
        <el-form-item label="上传类型:" prop="uploadType">
          <el-select style="width: 100%" placeholder="请选择banner上传类型" clearable
                     v-model="compileMainBannerData.uploadType">
            <el-option
              v-for="item in uploadTypes"
              :key="item.code"
              :label="item.msg"
        ...
        methods: {
            ...
            queryMainBannerList() {
                ...
                this.$axios({
                    ...
                    if (res.data.data.status == this.Globel.defaultRequestStatus) {
                        this.bannerList = res.data.data.pageEntity.pageList
                        this.total = res.data.data.pageEntity.total;
                    }
                })
